...
def win1():
    ...
    def read_through_pdf():
        ...
        but2.destroy()
        label1.destroy()
        pt.pytesseract.tesseract_cmd = r"C:\Users\abc\AppData\Local\Programs\Tesseract-OCR\tesseract.exe"
            ...
            def play_button():
                ...
                def save_aud():
                    ...
                    for i in range(start,end):
                        ...
                        if content:
                            player.save_to_file(content,'AudioConvertorpage'+str(i+1)+'.mp3')
                            player.runAndWait()
                            player.stop()
